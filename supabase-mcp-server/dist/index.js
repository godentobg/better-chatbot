...
server.tool("test_supabase_connection", "Test the connection to a Supabase instance.", {
...
server.tool("get_supabase_tables", "Get information about tables in a Supabase database.", {
    supabaseUrl: z.string().url(),
    supabaseKey: z.string(),
}, async ({ supabaseUrl, supabaseKey }) => {
    try {
...
server.tool("query_supabase_table", "Query data from a specific table in Supabase.", {
    supabaseUrl: z.string().url(),
    supabaseKey: z.string(),
    tableName: z.string(),
